...
const ViewOptions = ({hasAbsoluteMode, hasZoomPan, citationLink, dataLink}: IViewOptions) => {
...
return(
  <div className='view-options'>
    { hasZoomPan && <button type='button' className={buttonClasses} >Reset zoom/pan</button>}
    { hasAbsoluteMode && <button type="button" className={buttonClasses}>toggle absolute mode</button>}
